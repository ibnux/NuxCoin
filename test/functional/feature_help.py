...
"""Verify that starting nuxcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nuxcoin with -h for help text")
        ...
        self.log.info("Start nuxcoin with -version for version information")
        ...
        self.log.info("Start nuxcoind with -fakearg to make sure it does not start")
