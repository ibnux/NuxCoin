# Support for Output Descriptors in NUXCOIN Core

Since NUXCOIN Core v0.17, there is support for Output Descriptors. This is a
...
on NUXCOIN's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing NUXCOIN Core wallets, a convenience function `combo` is
