...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nuxcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nuxcoin-tx [options] <hex-tx> [commands]  Update hex-encoded nuxcoin transaction\n" +
            "or:     nuxcoin-tx [options] -create [commands]   Create hex-encoded nuxcoin transaction\n" +
            "\n";
