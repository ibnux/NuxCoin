...
public:
    CMainParams() {
        ...
        //vSeeds.emplace_back("seed-a.nuxcoin.loshan.co.uk");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 1122268, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xeb0f9ab89c037fd0b5f9ded7d27833895a1d3dd70b6325be5bdc03c877a449d2"));
        assert(genesis.hashMerkleRoot == uint256S("0x313b74207ab6a92afff519ffe2748820ca28682d7dc8f6aa6d4ae949cb27d22c"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.nuxcointools.com");
        //vSeeds.emplace_back("seed-b.nuxcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xddbad3e32ed812827048c371bc058ab8bf8cc827e15266de40968568d59d4c15"));
        assert(genesis.hashMerkleRoot == uint256S("0x313b74207ab6a92afff519ffe2748820ca28682d7dc8f6aa6d4ae949cb27d22c"));
