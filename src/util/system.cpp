...
const char * const BITCOIN_CONF_FILENAME = "nuxcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "NUXCOIN";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/NUXCOIN";
#else
    // Unix
    return pathRet / ".nuxcoin";
#endif
#endif
}
