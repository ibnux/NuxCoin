...
#if defined(NDEBUG)
# error "NUXCOIN cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "NUXCOIN Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if (nHeight == 1) return COIN * 84000000;
